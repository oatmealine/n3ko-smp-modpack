...
public abstract class BigBlock extends Block {
  ...
  public BlockSoundGroup getSoundGroup(BlockState state) {
    ...
    return new BlockSoundGroup(sg.volume, sg.pitch, N3KOSounds.SILENCE, sg.getStepSound(), sg.getPlaceSound(), sg.getHitSound(), sg.getFallSound());
  }
